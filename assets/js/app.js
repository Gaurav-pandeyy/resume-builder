...
// print CV
function printCV(){
    alert("Please make sure to enable 'Print backgrounds' in your browser's print settings to get the background color.");
    ...
    function changeBackgroundColor() {
        ...
        document.documentElement.style.setProperty('--clr-green', selectedColor);
    }
